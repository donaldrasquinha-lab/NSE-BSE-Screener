...
NIFTY_500_TICKERS = (
    ...
    "ALLCARGO,ALOKINDS,AMBER,AMBUJACEM,ANANTRAJ,ANGELONE,APARINDS,APOLLOHOSP,APOLLOTYRE,APTUS,ARE&M,"
    "ASAHIINDIA,ASHOKLEY,ASIANPAINT,ASTERDM,ASTRAL,ATUL,AUROPHARMA,AVANTIFEED,DMART,BEML,BLS,BSE,BALAMINES,"
    "BALKRISIND,BALRAMCHIN,BANDHANBNK,BANKBARODA,BANKINDIA,MAHABANK,BATAINDIA,BAYERCROP,BERGEPAINT,BDL,BEL,"
    "BHARATFORG,BHEL,BIOCON,BIRLACORPN,BSOFT,BLUEDART,BORORENEW,BOSCHLTD,CAMPUS,CESC,CGPOWER,CIEINDIA,CRISIL,"
    "CSBBANK,CANFINHOME,CANBK,CAPLIPOINT,CGCL,CARBORUNIV,CASTROLIND,CEATLTD,CENTRALBK,CDSL,CENTURYPLY,CENTURYTEX,"
    "CHAMBLFERT,CHALET,CHOLAFIN,CHOLAHLDNG,CUB,CIPLA,CLEAN,COALINDIA,COCHINSHIP,COFORGE,COLPAL,CONCOR,COROMANDEL,"
    "CRAFTSMAN,CREDITACC,CROMPTON,CUMMINSIND,CYIENT,DCMSHRIRAM,DLF,DABUR,DALBHARAT,DEEPAKFERT,DEEPAKNTR,DELHIVERY,"
    "DEVYANI,DIXON,DRREDDY,EIDPARRY,EIHOTEL,EPL,EASEMYTRIP,EICHERMOT,ELECON,EMAMILTD,ENDURANCE,ENGINERSIN,ERIS,"
    "ESCORTS,EXIDEIND,FDC,FSNKYS,FEDERALBNK,FACT,FINEORG,FINCABLES,FINPIPE,FSL,FORTIS,GRINFRA,GAIL,GLS,GMRINFRA,"
    "GEPIL,GHCL,GICRE,GIPCL,GLAXO,GLENMARK,GODREJAGRO,GODREJCP,GODREJPROP,GRANULES,GRAPHITE,GRASIM,GESHIP,"
    "GREAVESCOT,GRINDWELL,GUJALKALI,GUJGASLTD,GMDCLTD,GNFC,GPPL,GSFC,GSPL,HCLTECH,HDFCAMC,HDFCBANK,HDFCLIFE,"
    "HFCL,HLEGLAS,HAPPSTMNDS,HAVELLS,HEG,HEROMOTOCO,HINDALCO,HCOPPER,HINDPETRO,HINDUNILVR,HINDZINC,HONAUT,HUDCO,"
    "ICICIBANK,ICICIGI,ICICIPRULI,ISEC,IDBI,IDFCFIRSTB,IDFC,IIFL,IRB,IRCON,ITC,ITI,ITDCEM,INDIACEM,IBREALEST,"
    "INDIAMART,INDIANB,IEX,INDHOTEL,IOC,IRCTC,IRFC,INDIGOPNTS,IGL,INDUSINDBK,INDUSTOWER,INFIBEAM,INFY,INOXWIND,"
    "INTELLECT,INDIGO,IPCALAB,JBCHEPHARM,JKCEMENT,JKLACEMENT,JKPAPER,JMFINANCIL,JSWENERGY,JSWSTEEL,JSWINFRA,"
    "JAMNAAUTO,JSL,JINDALSTEL,JINDWORLD,JUBLFOOD,JUBLPHARMA,JUBLINGREA,JUSTDIAL,JYOTHYLAB,KALYANKJIL,KEI,KNRCON,"
    "KPITTECH,KRBL,KSB,KAJARIACER,KANSNEROL,KARURVYSYA,KEC,KENNAMET,KIMS,KIRLOSENG,KIRLPNU,KOLTEPATIL,KOTAKBANK,"
    "L&TFH,LTTS,LICHSGFIN,LICI,LAURUSLABS,LXCHEM,LEMONTREE,LINDEINDIA,LUPIN,LUXIND,MASFIN,MRF,MTARTECH,MTNL,MGL,"
    "MAHSEAMLES,M&MFIN,M&M,MANAPPURAM,MARICO,MARUTI,MASTEK,MEDPLUS,METROPOLIS,MFSL,MINDACORP,MSUMI,MOTILALOFS,"
    "MPHASIS,MCX,MUTHOOTFIN,NHPC,NLCINDIA,NMDC,NOCIL,NTPC,NATIONALUM,NAVINFLUOR,NAZARA,NEOGEN,NESCO,NESTLEIND,"
    "NETWORK18,NIPPONLIIF,OBEROIRLTY,ONGC,OIL,OLECTRA,PAYTM,OFSS,ORIENTELEC,POLICYBZR,PCBL,PIIND,PNBHOUSING,"
    "PNCINFRA,PVRINOX,PAGEIND,PATANJALI,PEL,PFC,POWERGRID,PRESTIGE,PRINCEPIPE,PRAJIND,PRIVISCL,PNB,QUESS,RBLBANK,"
    "RECLTD,RHIM,RITES,RADICO,RAIN,RAINBOW,RAJESHEXPO,RALLIS,RAMCOCEM,RATNAMANI,RAYMOND,REDINGTON,RELAXO,RELIANCE,"
    "RELIGARE,RVNL,SJVN,SKFINDIA,SRF,SANOFI,SAPPHIRE,SAREGAMA,SASTASUNDR,SBICARD,SBILIFE,SCHAEFFLER,SHOPERSTOP,"
    "SHREECEM,SHRIRAMFIN,SIEMENS,SOBHA,SOLARINDS,SONACOMS,SONATSOFTW,STARHEALTH,SBI,SAIL,SUNPHARMA,SUNTV,"
    "SUNDARMFIN,SUNDRMFAST,SUNTECK,SUPRAJIT,SUPREMEIND,SUZLON,SWANENERGY,SYNGENE,TARC,TCIEXP,TTKPRESTIG,TV18BRDCST,"
    "TVSMOTOR,TARSONS,TATACONSUM,TATACOMM,TATAELXSI,TATAMOTORS,TATAPOWER,TATASTEEL,TATAINVEST,TATATECH,TECHM,"
    "TEJASNET,TIMKEN,TITAN,TORNTPHARM,TORNTPOWER,TREND,TRIDENT,TRIVENI,UCOBANK,UBL,UDEV,UNIONBANK,UPL,UTIAMC,"
